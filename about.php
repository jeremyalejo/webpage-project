...
<html lang="en">
    ...
    <body>
        ...
        <!-- Page Header-->
        <header class="masthead" style="background-image: url('assets/img/aboutBG.jpg')">
            <div class="container position-relative px-4 px-lg-5">
                <div class="row gx-4 gx-lg-5 justify-content-center">
                    <div class="col-md-10 col-lg-8 col-xl-7">
                        <div class="site-heading">
                            <h1>About</h1>
                            <span class="subheading">What the website is about</span>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container px-4 px-lg-5">
            <div class="row gx-4 gx-lg-5 justify-content-center">
                <div class="col-md-10 col-lg-8 col-xl-7">
                    <!-- Post preview-->
                    <p>This website will store data about the game "Valorant", which is created by Riot Games. The
                        data stored here contains description of the playable agents in the game, the game modes that 
                        each has its own rules, the maps that exists in the game and comments that will come from different users
                        who will view this website.
                    </p></br>
                </div>
            </div>
        </div>
